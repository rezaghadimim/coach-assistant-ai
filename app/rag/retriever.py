...
# Backward-compatible aliases for tests and internal call sites.
_corpus_cache_path = embed_cache.corpus_cache_path
_cache_key = embed_cache.cache_key
_CACHE_FORMAT_VERSION = embed_cache.CACHE_FORMAT_VERSION
_load_cache = embed_cache.load_cache
_save_cache = embed_cache.save_cache
...
# Re-export formatting helpers for backward-compatible import paths.
from app.rag import formatting as _formatting  # noqa: E402

format_coach_retrieval_context = _formatting.format_coach_retrieval_context
format_retrieval_context = _formatting.format_retrieval_context
