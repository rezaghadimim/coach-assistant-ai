...
from app.core.health import _probe_ollama_server, layer_availability
from app.core.observability import setup_logging

# Deprecated alias — prefer app.core.health.layer_availability (T-035).
_layer_availability = layer_availability
